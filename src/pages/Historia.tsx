          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <p>
                  Gustavo, ultramaratonista apaixonado, conhecia intimamente os desafios do corpo em longas distâncias. 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {equipe.map((membro, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-all duration-500 transform hover:scale-105 border-0">
                <CardHeader>
