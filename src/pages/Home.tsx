  ...
  return <div className="min-h-screen">
      ...
      backgroundImage: `url(${heroImage})`
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" className="text-lg px-8 py-4" onClick={() => window.open('https://api.whatsapp.com/send?phone=5516996008849&text=Olá!', '_blank')}>Agende sua primeira sessão</Button>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Button variant="warm" size="lg" className="text-lg px-8 py-4" onClick={() => window.open('https://api.whatsapp.com/send?phone=5516996008849&text=Olá!', '_blank')}>
            Fale conosco agora
          </Button>
        </div>
      </section>
