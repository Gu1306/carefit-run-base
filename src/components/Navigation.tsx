  ...
  const navigation: NavItem[] = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: "Canelite", href: "/canelite" },
        { name: "Fascite Plantar", href: "/fascite-plantar" },
        { name: "Dor no Joelho na Corrida", href: "/dor-no-joelho-na-corrida" },
        { name: "Tendinite do Aquiles", href: "/tendinite-do-aquiles" },
        { name: "Síndrome da Banda Iliotibial", href: "/sindrome-da-banda-iliotibial" },
        { name: "Fratura por Estresse", href: "/fratura-por-estresse" },
      ],
    },
